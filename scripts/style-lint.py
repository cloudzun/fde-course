...
- `#` = 篇标题（仅 00 / 第03 / 第05 / 第10 / 第13 / 第17 章开头）
- `##` = 章标题（`## 第 N 章 ...`，章号与中英文之间加空格）/ 附录（`## 附录 A：...`）
- `###` = 节（`### N.x ...`）
- 每篇末章有 `### 本篇收尾 · 甲乙方对照：<问题>`（不占编号）——篇末章为 02/04/09/12/16/18
...
H1_EXPECT = {
    ...
    '第10章_FDE角色体系.md': 1,
    '第13章_政策导向下的FDE转型挑战与应对.md': 1,
    '第17章_AI_FDE落地_Echo共识与对齐.md': 1,
    '附录_参考来源与官方资料.md': 1,
}
# 每篇末章（应有 `### 本篇收尾`）
SECTION_TAIL = [2, 4, 9, 12, 16, 18]
