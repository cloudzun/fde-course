...
> | 章节 | 本案例在该章的推进 |
> | :--- | :--- |
> | **第5章** | 原始访谈、利益相关者地图、数据盘点、快赢（多级库存水位）选择 |
> | **第6章** | 核心业务对象 Ontology 草图、原型边界与可信度、Demo、原型技术债 |
> | **第7章** | 数据质量治理、工程化（权限体系）、运维与可运营移交准备 |
> | **第8章** | 推广至 3 个生产基地、冠军用户网络、客户自运营与 FDE 撤出 |
> | **第9章** | 多级库存水位模型的识别→抽象→集成→两级验证（V1/V2，见 9.1） |
> | **第10–11章** | 五角色编制与 RACI（三人小组是谁、怎么协作） |
> | **第14章** | 政企/中国市场的组织、采购、信创与合规障碍 |
> | **第15章** | 成功标准、ROI（三口径）、Echo 与甲方/商务/法务协作 |
> | **第16章** | Agent/Eval/部署/回滚，最终四选一决策（见 16 章末"全书收束"模块） |
