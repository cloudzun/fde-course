...
> [!TIP]
> **给读者的方法论启示**：NHS 案例呼应第五篇第 14 章的政企/合规话题。FDE 在中国政企场景同样面临"数据不出域、等保合规、极速见效"的三重约束——**合规不是速度的敌人，而是设计的前置输入**。把合规当成第一天就要解的题，而非上线前的补丁。
...
> [!TIP]
> **给读者的对标提示**：读完 Palantir 的 PPT 标杆，请带着一个问题进入后续章节——**我所在的乙方组织，在 People / Process / Technology 上分别处于什么水平？哪一维度是我的短板？** 第五篇第 14 章会给你一张可自查的 PPT 转型对照表。
...
> | **第 14 章** | 政企/中国市场的组织、采购、信创与合规障碍 |
> | **第 15 章** | 成功标准、ROI（三口径）、Echo 与甲方/商务/法务协作 |
> | **第 16 章** | Agent/Eval/部署/回滚，最终四选一决策（"全书收束"模块） |
...
2. **FDE 介入方式**：两名 FDE + 一名业务策略师，前置完成等保三级与数据合规约束确认（第 14 章的清单），明确"数据不出域、全程留痕"。
...
7. **方法论启示**：政企/金融场景中，**合规（第 14 章）不是速度的敌人，而是第一天的设计输入**；FDE 撤出（第 8 章的三级路线图）在客户 IT 成熟度较高的场景可以更快达成。
