...
> [!NOTE]
> **本章导读**：用五个真实案例（空客、BP、NHS、财富500强、美国陆军）印证第3章讲的 FDE 体系如何在战场发挥威力。每个案例遵循统一的"背景挑战 → FDE做了什么 → 核心成果 → 能力回注"四段式，并提炼给读者的方法论启示；4.6 汇总能力回注图谱，4.7 用 PPT 框架做整体透视，**4.8 补两个国产场景的教学案例（制造业供应链 / 城商行监管报送，综合提炼、非特指真实项目）**。
