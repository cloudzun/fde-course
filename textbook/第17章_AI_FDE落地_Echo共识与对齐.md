...
- **共识**：签约时共同定义 3-5 个**可量化成功指标**（如缺料预警提前 7 天、报送周期缩短至 3 天——参照第 15 章案例的示意口径），并约定"指标未达标时的整改机制"，把成功标准从"交付了"升级为"价值兑现了"。
...
- 签约时共同定义 3-5 个**可量化成功指标**（如"缺料预警提前 7 天""报送周期缩短至 3 天"——参照第 15 章案例示意口径）；
